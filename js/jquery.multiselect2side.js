				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne btn' title='Add Selected'>&rsaquo;</p>" +
							"<p class='AddAll btn' title='Add All'>&raquo;</p>" +
							"<p class='RemoveOne btn' title='Remove Selected'>&lsaquo;</p>" +
							"<p class='RemoveAll btn' title='Remove All'>&laquo;</p>")
							:
							("<p class='AddOne btn' title='Add Selected'>&lsaquo;</p>" +
							"<p class='AddAll btn' title='Add All'>&laquo;</p>" +
							"<p class='RemoveOne btn' title='Remove Selected'>&rsaquo;</p>" +
							"<p class='RemoveAll btn' title='Remove All'>&raquo;</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
